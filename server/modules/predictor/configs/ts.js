const telanganaConfig = {
  ...
  categories: {
    ...
    "Management Quota B - Local": ["CAT B-FEM", "CAT B-FEM-MSM", "CAT B-GEN", "CAT B-GEN-MSM"],
    "Management Quota B - Unreserved": ["CAT B-FEM", "CAT B-FEM-MSM", "CAT B-GEN", "CAT B-GEN-MSM", "CAT B-ArmyWards","MQ1"],
    "NRI Quota": ["NRI-FEM", "NRI-FEM-MSM", "NRI-GEN", "NRI-GEN-MSM"],
  },
};
