const punjabConfig = {
  ...
  categories: {
    ...
    "Christian Minority Quota": ["2A", "2A_To_2G_NRI", "2B", "2C", "2D", "2E", "2F", "2G","Open"],
    ...
    "All India Quota": ["AIQ", "BC", "Backward Area", "Border Area", "Defence", "JK", "Open", "RA", "SC", "Sports", "TA" ,"Open (Converted)","PwD"],
    "In-Service Quota":["GEN-IP","GEN-PwD-IP","EWS-IP"]
  },
};
