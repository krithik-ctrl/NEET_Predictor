          ...
          {STATES.map(({ name, count }) => (
            ...
            >
              <Link
                ...
                className="group flex h-full w-full flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm transition-shadow duration-200 hover:shadow-xl focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600"
              >
                ...
                <div className="flex flex-1 flex-col p-5">
                  ...
                  <span className="mt-4 inline-flex w-fit items-center gap-1.5 rounded-lg bg-blue-600/10 px-3 py-2 text-xs font-semibold text-blue-600 transition-colors duration-200 group-hover:bg-blue-600 group-hover:text-white">
                    Predict for {name}
                    <ArrowRight
